...
inline void gemm_ukernel_Cresident_SIMD_10x2(int mr, int nr, int kc, DTYPE *Ar, int ldA, DTYPE *Br, int ldB, DTYPE *C, int ldC, char orderC, DTYPE beta) {
// mr x nr = 10 x 2 micro-kernel and C resident in regs.
// Inputs:
