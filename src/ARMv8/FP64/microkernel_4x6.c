...
inline void gemm_ukernel_Cresident_SIMD_4x6(int mr, int nr, int kc, DTYPE *Ar, int ldA, DTYPE *Br, int ldB, DTYPE *C, int ldC, char orderC, DTYPE beta) {
// mr x nr = 4 x 6 micro-kernel and C resident in regs.
// Inputs:
...
//   - Br packed by rows, with leading dimension nr = 6
  ...
  vregister Cr0_0, Cr0_1, Cr0_2, Cr0_3, Cr0_4, Cr0_5, 
            Cr1_0, Cr1_1, Cr1_2, Cr1_3, Cr1_4, Cr1_5, 
  ...
  vinit(Cr1_0); vinit(Cr1_1); vinit(Cr1_2); vinit(Cr1_3); vinit(Cr1_4); vinit(Cr1_5); 
  vinit(ar0); vinit(ar1); 
