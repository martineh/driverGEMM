...
inline void gemm_ukernel_Cresident_SIMD_2x4(int mr, int nr, int kc, DTYPE *Ar, int ldA, DTYPE *Br, int ldB, DTYPE *C, int ldC, char orderC, DTYPE beta) {
// mr x nr = 2 x 4 micro-kernel and C resident in regs.
// Inputs:
