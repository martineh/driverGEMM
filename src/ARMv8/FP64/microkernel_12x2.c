...
inline void gemm_ukernel_Cresident_SIMD_12x2(int mr, int nr, int kc, DTYPE *Ar, int ldA, DTYPE *Br, int ldB, DTYPE *C, int ldC, char orderC, DTYPE beta) {
// mr x nr = 12 x 2 micro-kernel and C resident in regs.
// Inputs:
...
//   - Br packed by rows, with leading dimension nr = 2
  ...
  vregister Cr0_0, Cr0_1, 
            ...
            Cr5_0, Cr5_1, 
            A0_0;
  vregister ar0, ar1, ar2, ar3, ar4, ar5, br0; 
  ...
  vinit(Cr4_0); vinit(Cr4_1); 
  vinit(Cr5_0); vinit(Cr5_1); 
