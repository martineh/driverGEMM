...
inline void gemm_ukernel_Cresident_SIMD_2x8(int mr, int nr, int kc, DTYPE *Ar, int ldA, DTYPE *Br, int ldB, DTYPE *C, int ldC, char orderC, DTYPE beta) {
// mr x nr = 2 x 8 micro-kernel and C resident in regs.
// Inputs:
...
//   - Br packed by rows, with leading dimension nr = 8
  ...
  vregister Cr0_0, Cr0_1, Cr0_2, Cr0_3, Cr0_4, Cr0_5, Cr0_6, Cr0_7, A0_0, A0_1, A0_2, A0_3, A0_4, A0_5, A0_6, A0_7;
