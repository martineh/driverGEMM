...
{\
    ...
    vupdate(Cr3_2, ar3, br1, 0);\
    vupdate(Cr3_3, ar3, br1, 1);\
    vupdate(Cr4_0, ar4, br0, 0);\
    vupdate(Cr4_1, ar4, br0, 1);\
    vupdate(Cr4_2, ar4, br1, 0);\
    vupdate(Cr4_3, ar4, br1, 1);\
    vupdate(Cr5_0, ar5, br0, 0);\
    vupdate(Cr5_1, ar5, br0, 1);\
    vupdate(Cr5_2, ar5, br1, 0);\
    vupdate(Cr5_3, ar5, br1, 1);\
    baseA += Amr; baseB += Bnr;\
} 

inline void gemm_ukernel_Cresident_SIMD_12x4(int mr, int nr, int kc, DTYPE *Ar, int ldA, DTYPE *Br, int ldB, DTYPE *C, int ldC, char orderC, DTYPE beta) {
// mr x nr = 12 x 4 micro-kernel and C resident in regs.
// Inputs:
...
//   - Br packed by rows, with leading dimension nr = 4
  ...
  vregister Cr0_0, Cr0_1, Cr0_2, Cr0_3, 
            ...
            Cr5_0, Cr5_1, Cr5_2, Cr5_3, 
            A0_0;
  vregister ar0, ar1, ar2, ar3, ar4, ar5, br0, br1; 
  ...
  vinit(Cr5_0); vinit(Cr5_1); vinit(Cr5_2); vinit(Cr5_3); 
  vinit(ar0); vinit(ar1); vinit(ar2); vinit(ar3); vinit(ar4); vinit(ar5); 
  vinit(br0); vinit(br1); 
  if (orderC == 'C') { 
    Aptr = &Ar[0]; 
    Bptr = &Br[0]; 
  ...
  vstore(&Ctref(6, 2), Cr3_2); 
  vstore(&Ctref(6, 3), Cr3_3); 
  vstore(&Ctref(8, 0), Cr4_0); 
  vstore(&Ctref(8, 1), Cr4_1); 
  vstore(&Ctref(8, 2), Cr4_2); 
  vstore(&Ctref(8, 3), Cr4_3); 
  vstore(&Ctref(10, 0), Cr5_0); 
  vstore(&Ctref(10, 1), Cr5_1); 
  vstore(&Ctref(10, 2), Cr5_2); 
  vstore(&Ctref(10, 3), Cr5_3); 
  ...
  if ( beta != zero ) {
    ...
    vload(A0_0, &Ccol(8, 3));
    Cr4_3 += beta * A0_0; 
    vload(A0_0, &Ccol(10, 0));
    Cr5_0 += beta * A0_0; 
    vload(A0_0, &Ccol(10, 1));
    Cr5_1 += beta * A0_0; 
    vload(A0_0, &Ccol(10, 2));
    Cr5_2 += beta * A0_0; 
    vload(A0_0, &Ccol(10, 3));
    Cr5_3 += beta * A0_0; 
  }
  ...
  vstore(&Ccol(6,2), Cr3_2);
  vstore(&Ccol(6,3), Cr3_3);
  vstore(&Ccol(8,0), Cr4_0);
  vstore(&Ccol(8,1), Cr4_1);
  vstore(&Ccol(8,2), Cr4_2);
  vstore(&Ccol(8,3), Cr4_3);
  vstore(&Ccol(10,0), Cr5_0);
  vstore(&Ccol(10,1), Cr5_1);
  vstore(&Ccol(10,2), Cr5_2);
  vstore(&Ccol(10,3), Cr5_3);
    } 
}
