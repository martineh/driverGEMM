...
inline void gemm_ukernel_Cresident_SIMD_8x4(int mr, int nr, int kc, DTYPE *Ar, int ldA, DTYPE *Br, int ldB, DTYPE *C, int ldC, char orderC, DTYPE beta) {
// mr x nr = 8 x 4 micro-kernel and C resident in regs.
// Inputs:
...
//   - Br packed by rows, with leading dimension nr = 4
  ...
  vregister Cr0_0, Cr0_1, Cr0_2, Cr0_3, 
            ...
            A0_0;
  vregister ar0, ar1, ar2, ar3, br0, br1; 
