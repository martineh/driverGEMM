...
inline void gemm_ukernel_Cresident_SIMD_10x4(int mr, int nr, int kc, DTYPE *Ar, int ldA, DTYPE *Br, int ldB, DTYPE *C, int ldC, char orderC, DTYPE beta) {
// mr x nr = 10 x 4 micro-kernel and C resident in regs.
// Inputs:
//   - C stored in column-major order, with leading dimension ldC
//   - Ar packed by columns, with leading dimension mr = 10
//   - Br packed by rows, with leading dimension nr = 4
  ...
  vregister Cr0_0, Cr0_1, Cr0_2, Cr0_3, 
            ...
            A0_0;
  vregister ar0, ar1, ar2, ar3, ar4, br0, br1; 
